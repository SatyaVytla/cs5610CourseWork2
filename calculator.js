(function() {
  ...
  this.fetchDigit = function(val) {
      if(calcInstance.incomingDigitEntry ===true){
        ...
        if(calcInstance.minusSign === true && calcInstance.currOperand === "0"){
          var display = "-" + val;
          document.getElementById("displayComputed").value = display;
          calcInstance.currOperand = display;
          calcInstance.incomingDigitEntry =true;
          calcInstance.incomingOperatorEntry =false;
          calcInstance.minusSign = false;
        }
        else{
   ...
   this.fetchOperator = function(val){
     ...
     if(calcInstance.incomingOperatorEntry === true && val === '-' && calcInstance.currOperand=== "0")
     {
       document.getElementById("displayComputed").value = "-"
       calcInstance.minusSign = true;
       return;
     }
     if(val === "c" ){
       reset();
